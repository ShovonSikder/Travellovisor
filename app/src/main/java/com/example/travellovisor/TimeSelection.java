...
import com.example.travellovisor.transportation.Model;
import com.example.travellovisor.transportation.MyViewHolder;
...
public class TimeSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String to=getIntent().getStringExtra("id");
